...
select
    {{ dbt_utils.generate_surrogate_key(['trips.vendor_id', 'trips.tpep_pickup_datetime', 'trips.tpep_dropoff_datetime', 'trips.pu_location_id', 'trips.do_location_id', 'trips.payment_type', 'trips.passenger_count', 'trips.trip_distance', 'trips.total_amount']) }} as trip_sk,
    dim_date.date_id,
